...
<body>
    ...
    <div class="all_wrap">
        <div class="sub_top">
            ...
            <p class="sub_top_tit">승인/반려 선택</p>
        </div>
        ...
        <div class="container">
            <div class="location_wrap">
                <ul>
                    ...
                    <span class="skip">메인 바로가기</span></a></li>
                    <li class="location_arrow"></li>
                    <li class="prev_location">관리자 페이지</li>
                    <li class="location_arrow"></li>
                    <li class="now_location">승인/반려 선택</li>
                </ul>
            </div>
            ...
            <div class="section">
                ...
                <div class="text-right">
                    <select name="permitOption" onchange="location.href=this.value" class="all_select">
                        ...
                        <option value="/admin/applyList.do" selected>검토중</option>
                    ...
                    <tbody class="col_body">
                        <c:forEach items="${dto}" var="dto">
                            <tr id="list">
                                ...
                                <td>${dto.id}</td>
                                <td id="email" class="txt-overflow">${dto.email}</td>
                                <td class="m-table-none">
                                    <fmt:formatDate value="${dto.regdate}" pattern="yyyy-MM-dd HH:mm" />
                                </td>
                                <td>${dto.permit}</td>
                                <td>
                                    <input type="button" class="permit btn table_btn" id="per" value="후보" />
                                    <input type="button" class="deny btn table_btn" id="de" value="반려" />
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
        ...
        $("#per").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    alert("후보작으로 되었습니다.");
                    $('#list').remove();
                    location.href = '/admin/permitList.do';
                }
            });
        })
        ...
        $("#de").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    alert("반려되었습니다");
                    $('#list').remove();
                    location.href = '/admin/denyList.do';
                }
