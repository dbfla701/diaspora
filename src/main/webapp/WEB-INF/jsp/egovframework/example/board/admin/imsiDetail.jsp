...
<body>
    ...
    <div class="all_wrap">
        <div class="sub_top">
            ...
            <p class="sub_top_tit">임시글 상세보기</p>
        </div>
        ...
        <div class="container">
            <div class="location_wrap">
                <ul>
                    ...
                    <li class="location_arrow"></li>
                    <li class="now_location">임시글 상세보기</li>
                </ul>
            </div>

            <div class="section">
                <h4 class="sub_page_tit"><span class="tit_icon"></span>임시글 상세보기</h4>
                ...
                <form name="newsForm" role="form" enctype="multipart/form-data">
                    ...
                    <div class="text-center m-up-down">
                        <a href="/admin/newsUpdate.do?seq=${dto.seq}"  class="btn table_btn" >수정</a>
                        <a href="/admin/imsi.do" class="temporarily">목록</a>
                    </div>
                </form>
            </div>
